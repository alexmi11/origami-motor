This folder contains the PCB design file script in boards/designs.  This folder also contains zipped Gerber PCB files, and STL CAD files for the rigid components.
